    ...
    return (
        ...
        <div id="details" className={darkMode ? "dark" : ""}>
            ...
            <main className=' bg-white px-5 md:px-5 lg:px-40 lg:ml-28 dark:bg-[#1f1f1f]' >
                ...
                <div className="my-10 container grid md:grid-cols-2 lg:grid-cols-4 gap-4 mx-auto">
                ...
                <div className="mt-10 pb-10 container grid md:grid-cols-2 lg:grid-cols-3 gap-5 mx-auto">
